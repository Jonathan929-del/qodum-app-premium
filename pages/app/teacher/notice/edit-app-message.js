...
export default function App({route, navigation}) {
    ...
    const submitHandler = async () => {
        ...
        try {
            ...
            const notificationLink = `${configs.EXPO_PUBLIC_API_URL}/notifications/edit-notice`;
            ...
            navigation.navigate('teacher-notices', {isEdited:true});
                    ...
                    <View style={{gap:10}}>
                        ...
                        <View style={{gap:6}}>
                            ...
                            <View style={{width:'100%', position:'relative'}}>
                                <Icon name='pencil-outline' size={30} color='gray' style={{position:'absolute', zIndex:2, top:'25%', left:10}}/>
                                <PaperTextInput
                        ...
                        <View style={{gap:6}}>
                            <Text>Message</Text>
                            <View style={{width:'100%', position:'relative'}}>
                                <Icon name='pencil-outline' size={30} color='gray' style={{position:'absolute', zIndex:2, top:10, left:10}}/>
                                <PaperTextInput
