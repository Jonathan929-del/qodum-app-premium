...
import {TextInput as PaperTextInput, ActivityIndicator, Switch} from 'react-native-paper';
...
const CreateAssignment = ({navigation, route}) => {
    ...
    const onSubmit = async data => {
        ...
        try {
            ...
            // Api call
            const link = `${configs.EXPO_PUBLIC_API_URL}/assignments/edit`;
            const params = {
                id:assignment._id,
            ...
            setStates({...states, loading:false});
            navigation.navigate('teacher-assignments', {edited:true});
